...
public class WriterProjection extends Projection {
    ...
    private final static Reference SHARD_ID_REF = new Reference(SysShardsTableInfo.Columns.ID, RowGranularity.SHARD, IntegerType.INSTANCE);
    private final static Reference TABLE_NAME_REF = new Reference(SysShardsTableInfo.Columns.TABLE_NAME, RowGranularity.SHARD, StringType.INSTANCE);
    private final static Reference PARTITION_IDENT_REF = new Reference(SysShardsTableInfo.Columns.PARTITION_IDENT, RowGranularity.SHARD, StringType.INSTANCE);
