...
public class RowType extends DataType<Map<String, Object>> {
    ...
    public static final RowType EMPTY = new RowType(Collections.emptyList(), Collections.emptyList(), ColumnPolicy.DYNAMIC);
    private final List<String> names;
    private final List<DataType> types;
    private ColumnPolicy columnPolicy;

    public RowType(List<String> names, List<DataType> types, ColumnPolicy columnPolicy) {
        this.names = names;
        this.types = types;
