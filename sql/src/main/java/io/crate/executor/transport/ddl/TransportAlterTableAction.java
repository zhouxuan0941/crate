...
@Singleton
public class TransportAlterTableAction extends AbstractDDLTransportAction<AlterTableRequest, AlterTableResponse> {

    private static final String ACTION_NAME = "crate/table/alter";
    ...
    @Inject
    public TransportAlterTableAction(Settings settings,
        ...
        super(settings, ACTION_NAME, transportService, clusterService, threadPool, actionFilters,
            indexNameExpressionResolver, AlterTableRequest::new, AlterTableResponse::new, AlterTableResponse::new,
            "alter-table");
