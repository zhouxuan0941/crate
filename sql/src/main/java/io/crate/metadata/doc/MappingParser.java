    ...
    static class Context {
        ...
        public ImmutableMap<ColumnIdent, Reference> createReferences(TableIdent tableIdent) {
            ...
            while (nameIt.hasNext()) {
                ColumnIdent columnIdent = ColumnIdent.fromPath(nameIt.next());
                Reference reference = new Reference(
                    new ReferenceIdent(tableIdent, columnIdent), RowGranularity.DOC, typeIt.next());
