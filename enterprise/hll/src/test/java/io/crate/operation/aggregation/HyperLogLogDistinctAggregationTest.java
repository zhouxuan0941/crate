...
public class HyperLogLogDistinctAggregationTest extends AggregationTest {
    ...
    @Test
    public void testWithInvalidPrecision() throws Exception {
        expectedException.expect(IllegalArgumentException.class);
        expectedException.expectMessage("precision must be >= 4");
        executeAggregationWithPrecision(DataTypes.INTEGER, new Object[][]{{4, 1}, {6, 1}});
    }
