...
.. FIXME: need a full list of available loggers
...
.. FIXME: how to configure root logger?
...
.. FIXME: is the above correct? specifically ``1``

.. _conf-logging-gc-log-dir:

``CRATE_GC_LOG_DIR``: *path to logs directory* (default: varies)
  The log file directory.

  For `basic installations`_, the ``logs`` directory located in the
  :ref:`env-crate-home` directory is default.
